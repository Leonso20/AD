...
#
# ********************************************************************************
#to find out which computers in Active Directory a user is logged in.
#Set variables
$progress = 0
...
#Start search
$computers = Get-ADComputer -Filter {Enabled -eq 'true' -and operatingsystem -like 'Windows 10 Enterprise'}
