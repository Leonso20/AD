...
Retrieves  certificates from a local or remote system.
 ...
 #example
Get-Certificate -Computername 'sopslyncapp' -StoreName My -StoreLocation  LocalMachine 

#Lists all certificates
Get-Certificate -Computername 'sopslyncapp' -StoreName My -StoreLocation  LocalMachine -DaysUntilExpired 14 | Select  Subject, DaysUntilExpired,NotAfter

#  Lists all  certificates that Expire in 14 days or has already expired
Get-Certificate -Computername 'sopslyncapp' -StoreName My -StoreLocation  LocalMachine -DaysUntilExpired 14 -HideExpired |Select  Subject, DaysUntilExpired,NotAfter