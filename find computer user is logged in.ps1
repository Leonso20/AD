...
.EXAMPLE
    Get-LoggedInUser -ComputerName LMVM00249.semcty.net
    Display all the users that are logged in S100562
 
.EXAMPLE
    Get-LoggedInUser -ComputerName S100562.semcty.net -UserName rHamilton
    Get-LoggedInUser -ComputerName S102282.semcty.net -UserName rHamilton
...
#Get-LoggedInUser -ComputerName s103559.semcty.net 
#Get-LoggedInUser -ComputerName d14026.semcty.net 