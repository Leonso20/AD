...
function Check_User($User_Object)
{
         ...
         $L_Output_Alias.Text = $User_Object.mailnickname;
         ...
         #Attribute Details
         $L_Output_Attribute_1.Text = $User_Object.extensionAttribute1;
         $L_Output_Attribute_5.Text = $User_Object.extensionAttribute5;
         $L_Output_Attribute_6.Text = $User_Object.extensionAttribute6;
         $L_Output_Attribute_7.Text = $User_Object.extensionAttribute7;
         $L_Output_Attribute_8.Text = $User_Object.extensionAttribute8;
         $L_Output_Attribute_9.Text = $User_Object.extensionAttribute9;
         $L_Output_Attribute_10.Text = $User_Object.extensionAttribute10;
         $L_Output_Attribute_11.Text = $User_Object.extensionAttribute11;
         $L_Output_Attribute_12.Text = $User_Object.extensionAttribute12;
...
$L_Title.width = 25;
$L_Title.height = 5;
$L_Title.location = New-Object System.Drawing.Point(585,12);
...
$L_Output_Attribute_1.text = "Staff";
...
$L_Output_Attribute_6.text = "Adjuncts";
...
$L_Output_Attribute_7.text = "Students";
...
$L_Output_Attribute_8.text = "FullTimeFaculty";
...
$L_Output_Attribute_9.text = "Career";
...
$L_Output_Attribute_10.text = "Professional";
...
$L_Output_Attribute_11.text  = "Administrative";
...
$L_Output_Attribute_12.text = "TempStaff";
...
$Form_MAIN.controls.AddRange(@($L_Title,$GB_Input,$GB_Identity_Details,$GB_Attribute_Details,$GB_Organization_Details,$GB_Account_Details,$GB_Location_Details,$GB_Group_Membership,$GB_Member_Of))
...
$GB_Location_Details.controls.AddRange(@($B_Search,$L_Location_Details,$L_LDAP_Location,$L_Output_LDAP_Location,$L_Home_Directory,$L_Output_Home_Directory,$L_Mapped_To,$L_Output_Mapped_To))
